...
The shared Site uses a Cloudflare Worker and D1 database. The GitHub Pages edition is fully static, so it creates one autonomous world per browser profile, stores that world in IndexedDB, and catches up elapsed time when reopened.
