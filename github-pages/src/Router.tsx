...
import { DevelopmentMethod } from "../../app/survival/development-method";
import type {
  PlanetHistoryEvent,
...
function SurvivalMethodPage() {
  return <main className="survival-method-page">
    ...
    <section className="survival-method-research"><p>RESEARCH IS AN ACTION, NOT AN UNLOCK BUTTON</p><h2>A foundation for discovery, not automatic modern technology.</h2><p>The world implements simplified heat transfer, combustion, separation, ceramic firing, containment, copper and iron reduction, hot working, yield, waste and tool wear. Predictions, interventions and measurements remain separate records. The 28 geological families are raw inputs, not pure elements, and many still lack executable processing rules. More time does not automatically produce technology.</p><DevelopmentMethod /></section>
