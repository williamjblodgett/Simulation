    ...
    return Response.json(
      {
        ...
        sync: {
          ...
          reconstructionResolution: snapshot.reconstruction.resolution,
          coverageFromDay: snapshot.reconstruction.coverageFromDay,
          coarseEpochDays: snapshot.reconstruction.coarseEpochDays,
        },
      },
      { headers: PLANET_NO_STORE_HEADERS },
    );
